...
CREATE TABLE "PokemonCardType" (
    ...
    CONSTRAINT "PokemonCardType_pokemonCardId_fkey" FOREIGN KEY ("pokemonCardId") REFERENCES "PokemonCard" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "PokemonCardType_typeId_fkey" FOREIGN KEY ("typeId") REFERENCES "Type" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
